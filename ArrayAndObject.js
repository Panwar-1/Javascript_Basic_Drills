...
//Help the dealer find out which car has an id of 33 by logging the car's year, make, and 
//model in the console log provided to you below:
// console.log(`Car 33 is a *car year goes here* *car make goes here* *car model goes here*`);

/*
let carThirtyThree = inventory.filter(car => car.id === 33)
carThirtyThree = carThirtyThree[0]
// console.log(carThirtyThree.id);
...
console.log(`${carMake} And ${carModel}`);
*/
...
// let sortedData = inventory.sort((first, second) => {
//     if (first.car_model > second.car_model) { return 1 }
//     else if (first.car_model < second.car_model) { return -1 }
//     else { return 0 }
// });
...
// let sortedData = carYear.sort((first, second) => first - second);
// console.log(sortedData);
